...
$book_id = isset($_GET['id']) ? intval($_GET['id']) : 0; // Lưu ý: URL thường là edit_book.php?id=1
if ($book_id == 0 && isset($_GET['book_id'])) {
    $book_id = intval($_GET['book_id']);
}

// 3. Lấy thông tin chi tiết của sách (Kèm ảnh và danh sách ID tác giả)
// Sử dụng subquery để lấy 1 ảnh đại diện và gom nhóm tác giả tránh lỗi trùng lặp dòng
$sql = "SELECT b.*, 
...
// Chuyển danh sách ID tác giả (chuỗi "1,3,5") thành mảng để dễ kiểm tra
    ...
    <form id="edit-book-form" enctype="multipart/form-data">
        ...
        <div class="form-row" style="display:flex; gap:20px;">
            <div style="flex:1">
                ...
                <input type="number" name="publish_year" value="<?= $book['publish_year'] ?>" min="1900" max="<?= date('Y') + 1 ?>">
            </div>
            <div style="flex:1">
            ...
            <div style="flex:1">
                ...
                <input type="number" name="weight" value="<?= $book['weight'] ?>">
            </div>
        </div>
        ...
        <div class="form-row" style="display:flex; gap:20px;">
            ...
            <div style="flex:1">
                ...
                <input type="number" step="1000" name="discounted_price" value="<?= $book['discounted_price'] ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" name="stock_quantity" value="<?= $book['stock_quantity'] ?>">
        </div>
