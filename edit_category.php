...
<main class="book-management">
    <h2>Sửa danh mục: <?= htmlspecialchars($current_cat['name']) ?></h2>
    ...
    <form id="add-book-form"> <input type="hidden" name="category_id" value="<?= $current_cat['category_id'] ?>">
        ...
        <a href="admin_categorymanagement.php" style="margin-left: 10px; text-decoration: none; color: #666;">Quay lại</a>
    </form>
</main>
